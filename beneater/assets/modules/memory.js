...
export default ({ namespace, prog, ri, ro, a0, a1, a2, a3, CLK='CLK' }) => ({
    namespaced: true,
    ...
    modules: {
        ...
        multiplexerHigh: sn74157({
            ...
            pin2: (s, g) => s[namespace].switchState[7],
            pin3: (s, g) => g.bus[7],
            pin5: (s, g) => s[namespace].switchState[6],
            pin6: (s, g) => g.bus[6],
            pin11: (s, g) => s[namespace].switchState[5],
            pin10: (s, g) => g.bus[5],
            pin14: (s, g) => s[namespace].switchState[4],
            pin13: (s, g) => g.bus[4],
        ...
        multiplexerLow: sn74157({
            ...
            pin2: (s, g) => s[namespace].switchState[3],
            pin3: (s, g) => g.bus[3],
            pin5: (s, g) => s[namespace].switchState[2],
            pin6: (s, g) => g.bus[2],
            pin11: (s, g) => s[namespace].switchState[1],
            pin10: (s, g) => g.bus[1],
            pin14: (s, g) => s[namespace].switchState[0],
        ...
        multiplexerManual: sn74157({
            ...
            pin14: (s, g) => s[namespace].storeInMemoryButton〇,

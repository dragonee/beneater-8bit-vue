    ...
    actions: {
        ...
        async programMicrocode({ commit }) {
            ...
            const instructionsToMicrocode = (instructions) => {
                const microcodeLow = Array(2048).fill(null).map(() => Array(8).fill(false));
                const microcodeHigh = Array(2048).fill(null).map(() => Array(8).fill(false));
        ...
        programOutputCode({ commit }) {
            ...
            const outputCode = Array(2048).fill(null).map(() => Array(8).fill(false));

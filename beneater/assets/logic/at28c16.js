...
export default ({ 
    ...
    return {
        ...
        state: () => ({
            words: Array(2048).fill(null).map(() => n(8))
        }),
        
        mutations: {
            setState(state, payload) {                    
                state.words.splice(addr(payload.address), 1, [
                    ...payload.word
                ])                
            },
        ...
        getters: {
            ...
            pin9: (s, g, rs, rg) => g.currentWord[0],
            pin10: (s, g, rs, rg) => g.currentWord[1],
            pin11: (s, g, rs, rg) => g.currentWord[2],
            pin13: (s, g, rs, rg) => g.currentWord[3],
            pin14: (s, g, rs, rg) => g.currentWord[4],
            pin15: (s, g, rs, rg) => g.currentWord[5],
            pin16: (s, g, rs, rg) => g.currentWord[6],
            pin17: (s, g, rs, rg) => g.currentWord[7],
        }
    }
}
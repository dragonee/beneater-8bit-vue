  ...
  >
    ...
    <g class="segGroup">
      <use
        ...
        x="0"
        y="0"
        :class="storedWord[0] ? 'on' : 'off'"
      ></use>
      <use
        xlink:href="#v-seg"
        x="-48"
        y="0"
        :class="storedWord[1] ? 'on' : 'off'"
        transform="scale(-1,1)"
      ></use>
      <use
        xlink:href="#v-seg"
      ...
      <use
        ...
        x="0"
        y="70"
        :class="storedWord[3] ? 'on' : 'off'"
      ></use>
      <use
        xlink:href="#v-seg"
        x="0"
        y="-80"
        :class="storedWord[4] ? 'on' : 'off'"
        transform="scale(1,-1)"
      ></use>
      <use
        xlink:href="#v-seg"
        x="0"
        y="0"
        :class="storedWord[5] ? 'on' : 'off'"
      ></use>
      <use
        xlink:href="#h-seg"
        x="0"
        y="35"
        :class="storedWord[6] ? 'on' : 'off'"
      ></use>
    </g>
    <circle
      cx="52"
